...
#     print("Eliminate tutte le serie storiche giornaliere in DatapointsSerieComputed!")
...
#         PM10_daily_mean_cathegory_label = [ evaluate_PM10(i)[0] for i in PM10_daily_mean ]
#         PM25_daily_mean_cathegory_label = [ evaluate_PM25(i)[0] for i in PM25_daily_mean ]
...
#                         "PM10_daily_mean_cathegory_label" : PM10_daily_mean_cathegory_label,
#                         "PM25_daily_mean_cathegory_label" : PM25_daily_mean_cathegory_label,
...
#                                                     PM10_mean_cathegory_label_values = '["' + '", "'.join(str(e) for e in  serie_storica['PM10_daily_mean_cathegory_label'] ) +'"]',
#                                                     PM25_mean_cathegory_label_values = '["' + '", "'.join(str(e) for e in  serie_storica['PM25_daily_mean_cathegory_label'] ) +'"]',
